...
run-clang-tidy app configs:
    python {{zpp_lib_dir}}/scripts/run_clang_tidy.py --app {{app}} --board {{default_board}} --shield {{default_shield}} --configs {{quote(configs)}} --header-root "zpp_include" --wd {{working_dir}}