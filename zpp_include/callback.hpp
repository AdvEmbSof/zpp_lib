...
struct member_type<M C::*> : type_identity<M> { };
...
struct unqualify_fn<R(Args...)> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) &> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) const> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) const &> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) volatile> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) volatile &> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) const volatile> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) const volatile &> : type_identity<R(Args...)> { };
...
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) noexcept> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) & noexcept> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) const noexcept> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) const & noexcept> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) volatile noexcept> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) volatile & noexcept> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) const volatile noexcept> : type_identity<R(Args...)> { };
template <typename R, typename... Args>
struct unqualify_fn<R(Args...) const volatile & noexcept> : type_identity<R(Args...)> { };
#endif
...
template <typename R, typename F, typename... Args, enable_if_t<!std::is_void<R>::value, int> = 0>
...
public:
     ...
     */
    template<typename Obj, typename Method, typename std::enable_if_t<std::is_invocable_r<R, Method, Obj, ArgTs...>::value, int> = 0>
     ...
     */
    template<typename Fn, typename BoundArg, typename std::enable_if_t<std::is_invocable_r<R, Fn, BoundArg, ArgTs...>::value, int> = 0>
    ...
    template <typename F,
              typename = std::enable_if_t<
                  ...
                  !std::is_same<remove_cvref_t<F>, Callback>::value>>
 ...
 */
template <typename F>
Callback<detail::unqualify_fn_t<detail::member_type_t<decltype(&remove_cvref_t<F>::operator())>>>
callback(F &&f)
{
    return Callback<detail::unqualify_fn_t<detail::member_type_t<decltype(&remove_cvref_t<F>::operator())>>>(std::forward<F>(f));
}
